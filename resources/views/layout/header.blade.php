...
<head>
 ...
 <link rel="stylesheet" href="{{url('public/bower_components/select2/dist/css/select2.min.css')}}">
  ...
  <!-- HighChart -->
  <script src="{{url('public/js/highchart/highcharts.js')}}"></script>
  <script src="{{url('public/js/highchart/exporting.js')}}"></script>
  ...
  <div class="wrapper">
            ...
            <li class="dropdown user user-menu">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-header">
                  <p>
                    {{session('username')}} - {{session('tipe_user')}}
                ...
                <li class="user-footer">
                  ...
                  <div class="pull-right">
                    <a href="{{route('proses_logout')}}" class="btn btn-default btn-flat">Sign out</a>
                  </div>
                </li>
              </ul>
            </li>
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        @if (session('tipe_user')=='administrator')
        <li class="main_menu">
          <a href="{{route('twitter_scrape')}}">
            <i class="fa fa-twitter"></i> <span>Twitter Scrape</span>
          </a>
        </li>
        <li class="main_menu">
          <a href="{{route('instagram_scrape')}}">
            <i class="fa fa-instagram"></i> <span>Instagram Scrape</span>
          </a>
        </li>

        <li class="main_menu">
          <a href="{{route('facebook_scrape')}}">
            <i class="fa fa-facebook"></i> <span>Facebook Scrape</span>
          </a>
        </li>
        @endif
        
        <li class="main_menu">
          <a href="{{route('twitter_data',['offset'=>0])}}">
            <i class="fa fa-database"></i> <span>Twitter Data</span>
          </a>
        </li>
        <li class="main_menu">
          <a href="{{route('twitter_data',['offset'=>0])}}">
            <i class="fa fa-database"></i> <span>Instagram Data</span>
          </a>
        </li>

        <li class="main_menu">
          <a href="">
            <i class="fa fa-database"></i> <span>Facebook Data</span>
          </a>
        </li>

        <li class="main_menu">
          <a href="{{route('graphic')}}">
            <i class="fa fa-pie-chart"></i> <span>Graphic</span>
          </a>
        </li>


        <li class="main_menu treeview">
          <a href="#">
